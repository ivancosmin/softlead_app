                ...
                r.validate({
                    ...
                    success: function (data) {
                        setTimeout(function () {
                            ...
                            if (result['errs']) {
                                l.clearForm(), l.validate().resetForm(), i(l, "success", "Password recovery instruction has been sent to your email. ")
                            }
                            else{
                                l.clearForm(), l.validate().resetForm(), i(l, "danger", "The email does not exist. ")
                            }
                        }, 2e3)
                    }
                }))
